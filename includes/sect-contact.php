		...
		<div class="section-title">
			...
			<div class="row" data-aos="fade-up" data-aos-delay="100">
				...
				<div class="col-xl-6 ">
					...
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2458.9059732095902!2d5.242154277157967!3d51.95390607191834!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c65e49962ddcaf%3A0x31dc783d5f121a95!2sHeimanslaan%202%2C%204102%20JD%20Culemborg!5e0!3m2!1snl!2snl!4v1770808926582!5m2!1snl!2snl" width="480" height="360" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
				</div>
				...
				<div class="col-xl-6">
					<form action="proces_contact.php" method="POST" class="php-email-form">
						...
						<div class="my-3">
							<div class="error-message" style="display: <?php if (isset($_GET['resc']) && $_GET['resc'] == '2') echo 'block'; else echo 'none'; unset($_GET['rc']);?>;">Het emailadres is niet ingevuld. Probeer opnieuw ajb.</div>
							<div class="error-message" style="display: <?php if (isset($_GET['resc']) && $_GET['resc'] == '1') echo 'block'; else echo 'none'; unset($_GET['rc']);?>;">Je bericht is NIET verzonden. Probeer het later nog eens.</div>
							<div class="sent-message" style="display: <?php if (isset($_GET['resc']) && $_GET['resc'] == '0') echo 'block'; else echo 'none'; unset($_GET['rc']);?>;">Je bericht is verstuurd. Dankjewel!</div>
						</div>
