	 <!-- ======= Over jobgroups ======= -->
	 <section id="Jobgroup" class="<?php echo (Tools::sectOne() ? 'section-one' : 'section-two'); ?>">
	 	<div class="container" data-aos="fade-up">
	 		...
	 		<div class="section-title">
	 			<h3>Hoe ziet een JobGroep er uit?</h3>
	 		</div>
	 		<div class="row">
	 			...
	 			<div class="col-lg-8 d-flex align-items-stretch mb-5 mb-lg-0">
					<div class="card px-lg-5" data-aos="fade-up" data-aos-delay="200">
	 				...
	 				<ol>
	 					...
	 					<li><span>Wat wil ik?</span> Inzicht krijgen in het werk dat je leuk en uitdagend vind en dat past bij het leven dat je wilt leiden.</li>
	 					<li><span>Hoe solliciteer ik?</span> Een beter beeld krijgen van de meest effectieve sollicitatiemethoden. </li>
	 					<li><span>Hoe presenteer ik mezelf?</span> Krijg informatie over het belang van netwerken (hoe en wat) en leer tips & tricks om jezelf goed te laten zien op je cv, in je motivatiebrief en op sociale media.</li>
	 					<li><span>Hoe vind ik een baan?</span> Zoeken naar een passende nieuwe uitdaging en bijbehorende vacatures.</li>
	 					<li><span>Dit ben ik!</span> In een veilige omgeving oefenen van een sollicitatiegesprek of pitch, waarbij je opbouwende feedback krijgt van de trainer en mededeelnemers.</li>
	 				</ol>
					</div>
	 			</div>
				<div class="col-lg-2"></div>
	 			...
	 			<!-- <div class="col-lg-6 d-flex align-items-stretch mb-5 mb-lg-0">
	 				...
	 				<p>Een bijeenkomst ziet er zo uit:</p>
	 				<ul>
	 					<li><span>Intro:</span> inloop met koffie en thee, kennismaking</li>
	 					<li><span>JobTalk:</span> korte interactieve workshop</li>
	 					<li><span>GroupTalk:</span> opdrachten in kleine groepjes om feedback van elkaar te krijgen</li>
	 					<li><span>Afterparty:</span> blijf napraten en vraag individueel advies van JobGroupLeiders</li>
	 				</ul>
					 </div>
	 			</div> -->
	 		</div>
	 	</div>
	 </section><!-- Over jobgroups Section -->