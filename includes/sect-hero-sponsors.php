<section id="hero" class="d-flex align-items-center" style="background: url('assets/img/hero_sponsoring.jpg'); background-size: cover; background-position: center; height: 75vh;">
<div id="overlay"></div>
